...
export function GoogleSignInButton({ onClick, disabled, loading }: GoogleSignInButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className="flex w-full items-center justify-center gap-3 border border-brand-border bg-white py-3.5 text-sm font-semibold text-brand-blueDark transition hover:border-brand-accent disabled:opacity-50"
    >
      <GoogleLogo />
